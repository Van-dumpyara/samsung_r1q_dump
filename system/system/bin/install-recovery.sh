#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/bootdevice/by-name/recovery$(getprop ro.boot.slot_suffix):82825216:a401a0b9bcdc4ff609e47bf55faa531b71d841d3; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/bootdevice/by-name/boot$(getprop ro.boot.slot_suffix):67108864:d6ba1ce82b4d437cfaa41264217482d7367dcb4d \
          --target EMMC:/dev/block/bootdevice/by-name/recovery$(getprop ro.boot.slot_suffix):82825216:a401a0b9bcdc4ff609e47bf55faa531b71d841d3 && \
